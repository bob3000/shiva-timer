...
export interface IStandardTimerScreenState {
...
export default class StandardTimerScreen extends React.Component<
  IStandardTimerScreenProps,
  IStandardTimerScreenState
> {
  ...
  constructor(props: IStandardTimerScreenProps) {
    super(props);
    ...
    this.state = {
      ...
      timers: [
        {
          intervals: [0, 10, 30, 60, 120, 300, 600],
          timeCurrent: 60,
          timeTotal: 60,
  ...
  private filterState(
    state: IStandardTimerScreenState,
  ): IStandardTimerScreenState {
    return state;
  }
...
const styles = StyleSheet.create<IStandardTimerScreenStyle>({
  aboutLink: {
    alignSelf: 'flex-end',
